...
from decoding import BeamAbstractor, AbsDecodeDataset
...
if __name__ == '__main__':
    ...
    # decode options
    parser.add_argument('--max_input', type=int, default=1500, help='maximum input length')
    ...
    if data_split == 'test':
       ...
       split, args.batch, args.max_dec_word, args.cuda, args.min_dec_word)